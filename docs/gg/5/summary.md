...
??? abstract "Diagramm zu T, p, $\rho$ und $v$"
    ...
    ![Diagramm der Schichten der Erde](./Erde_Schichten.png)
...
??? abstract "Diagramm der Magnetstreifenmuster"
    ![Magnetstreifenmuster](./Magnetstreifenmuster.png)
...
??? abstract "Beispiel eines Laufzeit-Diagramms"
    ![Laufzeit-Diagramm](./Laufzeitdiagramm.png)
