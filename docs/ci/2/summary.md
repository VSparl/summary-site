...
- Werden auch *permanente Dipole* genannt (siehe [hier](./summary.md#dispersionswechselwirkung-dispw) für den Grund)
...
---
## Zwischenmolekulare Wechselwirkungen (ZMW)

- Wechselwirkung zwischen Molekülen &rightarrow; Grund für **Aggregatzustände**
- viel **schwächer als Elektronenpaarbindungen**[^5]
- **Siedepunkt** des Moleküls hängt von Stärke der ZMW ab

    > Die Moleküle müssen stärker schwingen, um die ZMW zu überwinden und sich von einander zu lösen, wenn diese stark ist

??? abstract "ZMW und Kovalenzbindungen in Eis"
    ![ZMW und Kovalenzbindungen in Eis](Pasted%20image%2020250113173135.png)

[^5]: **Elektronenpaarbindung**: Bindung, die über bEPs von Atomen entsteht (z.B. $HCl$)

### Dipol/Dipol-Wechselwirkungen (DDW)

- **alle Dipole** gehen diese Wechselwirkung ein (auch bei unterschiedlichen Molekülen)
- grösserer **Dipolmoment** &rightarrow; stärkere Anziehung
- **Energie** wird beim *Zusammenlagern* der Dipole **frei**
- **Energie** wird bei der *Trennung* der Dipole **verbraucht**

??? abstract "Dipol/Dipol-Wechselwirkung bei Methanal"
    ![Dipol/Dipol-Wechselwirkung bei Methanal](Pasted%20image%2020250113174449.png)

### Wasserstoffbrücken (WBR, H-Brücken)

- $H$ hat Kernladung von $1+$ &rightarrow; schwach elektronegativ &rightarrow; meist die positive Seite in einer Bindung
- in **stark** polarer Bindung wird $H$-Kern vom Bindungspartner **weggedrückt**, während die Elektronen stark **angezogen** werden
- Entstehung eines "positiven Pols", am Rand des $H$-Atoms
- nEPs anderer Atome werden von $H$-Kern angezogen
- WBR sind **viel stärker als die [DDW](./summary.md#dipoldipol-wechselwirkungen-ddw)**, also richten sich Moleküle vorzugsweise nach dieser Kraft aus

!!! warning "Entstehungsbedingungen für WBR"
    - entsteht **nur** bei einer Bindung zwischen $H$ und einem $FOClN$-Atom (siehe [hier](./summary.md#polaritat))
    - **nur** nEPs von $FOClN$-Atomen werden genug fest zum $H$-Kern angezogen, um eine WBR zu bilden


### Dispersionswechselwirkung (DispW)

- auch Van der Waals-Wechselwirkung genannt (VdW)
- auch Londonsche Dispersionswechselwirkung
- viel **schwächer** als DDW und WBR
- Atome "wackeln" &rightarrow; Entstehung von Bereichen mit positiver / negativer Partialladung
- Entstehung von **temporären Dipolen**[^6]
...
> Je grösser die "Berührungsfläche" der Moleküle, desto grösser ist der Bereich, in dem Wechselwirkungen stattfinden

[^6]: im Gegensatz zu **permanenten Dipolen**, die **immer** einen Dipolmoment besitzen


## Anomalie von Wasser

- Feststoffe haben normalerweise **grössere** Dichten als ihre Flüssigkeiten
- Eis hat **kleinere** Dichte als Wasser
- in Eis bilden sich **WBR** mit jeweils 4 umgebenden Molekülen
- im entstehenden 6-Eck-Gitter sind die Moleküle **weniger dicht gepackt** als in der Flüssigkeit
- beim Schmelzen von Wasser &rightarrow; WBR brechen **teilweise** auf
- erst bei 4 °C sind praktisch alle WBR aufgelöst
- nach 4 °C beginnt die Dichte, mit steigender Temperatur abzunehmen