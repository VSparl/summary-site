...
flowchart LR
    ...
    EP --> FP["<b>Fiscal</b> policy<br>(through the state &rightarrow; goods flow)"]
    EP --> MP["<b>Monetary</b> policy<br>(through the SNB &rightarrow; money flow)"]

    FP --> T["Taxes"]
    FP --> I["Investment<br>(government spending)"]
    FP --> S["Subsidies<br>(transfer payments)"]

    MP --> IR["Interest rate level"]
    MP --> MS["Money supply"]
    MP --> ER["Exchange rate"]
```
...
| Conversion rates shall... | Be raised _(more CHF per EUR)_<br>= weaker currency / devaluation of the Swiss Franc<br>= more exports | Be lowered   |
